...
The powerpoint slides of the workshop, data simulation exercises and answers can be found on the github page of Julian Quandt: [Link to github page of Julian Quandt] (https://github.com/julianquandt/power-sim-workshop-bsi-230522)
